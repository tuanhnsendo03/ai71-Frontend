          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Rent A Car, Drive Your Dreams
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience seamless car rentals with technology-driven solutions. Perfect for professionals, families, and adventurers. Ready to roll?
              </p>
            </div>
